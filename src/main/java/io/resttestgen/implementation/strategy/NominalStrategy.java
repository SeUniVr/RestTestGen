...
public class NominalStrategy extends Strategy {
    ...
    public void start() {
        ...
        ParameterValueProvider experienceProvider = new ExperienceDrivenMultiParameterValueProvider();
        ...
        while (!sorter.isEmpty()) {
            ...
            nominalFuzzer.setParameterValueProvider(experienceProvider);
            List<TestSequence> nominalSequences = nominalFuzzer.generateTestSequences(50);
