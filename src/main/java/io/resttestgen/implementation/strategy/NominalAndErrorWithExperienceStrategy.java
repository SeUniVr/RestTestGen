...
public class NominalAndErrorWithExperienceStrategy extends Strategy {
    ...
    public void start() {
        ...
        long endTime = startTime + config.getTimeBudget();
        ...
        while (!sorter.isEmpty()) {
            ...
            List<TestSequence> nominalSequences = experienceFuzzer.generateTestSequences(20);
